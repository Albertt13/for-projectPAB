...
public class StadionTambahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stadion_tambah);
    ...
    private void tambahStadion() {
        APIRequestData ARD = RetroServer.konekRetrofit().create(APIRequestData.class);
        Call<StadionModelResponse> proses = ARD.ardCreate2(nama, lokasi, tahun, kapasitas, foto);
        ...
        proses.enqueue(new Callback<StadionModelResponse>() {
            ...
            public void onResponse(Call<StadionModelResponse> call, Response<StadionModelResponse> response) {
                ...
                Toast.makeText(StadionTambahActivity.this, "Kode : " + kode + ", Pesan : " + pesan, Toast.LENGTH_SHORT).show();
                finish();
            }

            @Override
            public void onFailure(Call<StadionModelResponse> call, Throwable t) {
                Toast.makeText(StadionTambahActivity.this, "Gagal Menghubungi Server", Toast.LENGTH_SHORT).show();
            }
        });
    }
}